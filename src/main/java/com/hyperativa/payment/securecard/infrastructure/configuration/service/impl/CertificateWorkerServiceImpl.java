...
@Service
public class CertificateWorkerServiceImpl implements CertificateWorkerService {
    ...
    private static final Logger log = LoggerFactory.getLogger(CertificateWorkerServiceImpl.class);
